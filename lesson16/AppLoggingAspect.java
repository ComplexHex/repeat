...
//    @Before("execution(public void lesson16.UserDAO.addUser())") // pointcut expression
...
//
//    @AfterReturning(
//            pointcut = "execution(public * lesson16.UserDAO.getAllUsers(..))",
//            returning = "result")
...
//
//    @AfterThrowing(
//            pointcut = "execution(public * lesson16.UserDAO.*)",
//            throwing = "exc")
//    public void afterThrowing(JoinPoint joinPoint, Throwable exc) {
//        System.out.println(exc); // logging
//    }
//
//    @After("execution(public * lesson16.UserDAO.*)")
//    public void afterMethod() {
//        System.out.println("After");
//    }

//    @Around("execution(public * lesson16.UserDAO.*(..))")
